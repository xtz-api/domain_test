...
class DomainService(object):
    def __init__(self, client, auto_delete=None, code=None, content=None, Type=None, domain=None, period=None,
                 renew_price=None,
                 zone=None, name=None, email=None, registration_type=None, status_mask=None, page_number=None,
                 page_size=None, verify_status_mask=None, register_list=None, auto_renew=None, ns_list=None,
                 template_id=None):
        self.client = client
    ...
    def domain_validate(self):
        ...
        params = {"test_domain": self.domian}
